 ...
 * @author Crack
 */
public class Admin_adddoc extends JFrame implements ActionListener {
   ...
   public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("insert into addd(did,fname,lname,age,sp,bg,gender,address,city,ph,ms,jd,ld,uname,pass)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
